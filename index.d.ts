...
/** A workaround for not being able to explicitly reference the global scope. */
declare class GlobalError extends Error {}

/** A workaround for not being able to explicitly reference the global scope. */
declare class GlobalRangeError extends RangeError {}

/** A workaround for not being able to explicitly reference the global scope. */
declare class GlobalReferenceError extends ReferenceError {}

/** A workaround for not being able to explicitly reference the global scope. */
declare class GlobalTypeError extends TypeError {}

/** A workaround for not being able to explicitly reference the global scope. */
declare class GlobalSyntaxError extends SyntaxError {}

/** A workaround for not being able to explicitly reference the global scope. */
declare class GlobalURIError extends URIError {}
...
declare module 'node-common-errors' {
     ...
     */
    export class AlreadyInUseError extends GlobalError {
        /**
     ...
     */
    export class ArgumentError extends GlobalError {
        /**
     ...
     */
    export class AuthenticationRequiredError extends GlobalError {
        /**
         * @param message     any message
         * @param inner_error the Error instance that caused the current error.
         *                    Stack trace will be appended.
     ...
     */
    export class ConnectionError extends GlobalError {
        /**
         * @param message     any message
         * @param inner_error the Error instance that caused the current error.
         *                    Stack trace will be appended.
     ...
     */
    export class HttpStatusError extends GlobalError {
        /**
     ...
     */
    export class InvalidOperationError extends GlobalError {
        /**
         * @param message     any message
         * @param inner_error the Error instance that caused the current error.
         *                    Stack trace will be appended.
     ...
     */
    export class SocketError extends GlobalError {
        /**
         * @param message     any message
         * @param inner_error the Error instance that caused the current error.
         *                    Stack trace will be appended.
     ...
     */
    export class NotPermittedError extends GlobalError {
        /**
         * @param message     any message
         * @param inner_error the Error instance that caused the current error.
         *                    Stack trace will be appended.
     ...
     */
    export class OutOfMemoryError extends GlobalError {
        /**
         * @param message     any message
         * @param inner_error the Error instance that caused the current error.
         *                    Stack trace will be appended.
     ...
     */
    export class RangeError extends GlobalRangeError {
        /**
         * @param message     any message
         * @param inner_error the Error instance that caused the current error.
         *                    Stack trace will be appended.
     ...
     */
    export class ReferenceError extends GlobalReferenceError {
        /**
         * @param message     any message
         * @param inner_error the Error instance that caused the current error.
         *                    Stack trace will be appended.
     ...
     */
    export class StackOverflowError extends GlobalError {
        /**
         * @param message     any message
         * @param inner_error the Error instance that caused the current error.
         *                    Stack trace will be appended.
     ...
     */
    export class SyntaxError extends GlobalSyntaxError {
        /**
         * @param message     any message
         * @param inner_error the Error instance that caused the current error.
         *                    Stack trace will be appended.
     ...
     */
    export class TimeoutError extends GlobalError {
        /**
     ...
     */
    export class TypeError extends GlobalTypeError {
        /**
         * @param message     any message
         * @param inner_error the Error instance that caused the current error.
         *                    Stack trace will be appended.
     ...
     */
    export class URIError extends GlobalURIError {
        /**
         * @param message     any message
         * @param inner_error the Error instance that caused the current error.
         *                    Stack trace will be appended.
    ...
    namespace data {
         ...
         */
        export class DataError extends GlobalError {
            /**
             * @param message     any message
    ...
    namespace io {
         ...
         */
        export class IOError extends GlobalError {
            /**
             * @param message     any message
             * @param inner_error the Error instance that caused the current
             *                    error. Stack trace will be appended.
